...
comments: true
tags: tools exploit
description: An utility to integrate ltrace in pwntools
---

[https://github.com/andreafioraldi/pwntrace](https://github.com/andreafioraldi/pwntrace)

This tool comes from my personal need during the development of an heap-based exploit.

It integrates ltrace with pwntools to speed up the exploit writing process.
